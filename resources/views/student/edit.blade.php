                    ...
                    <div class="col-md-6">
                        ...
                        <form action="{{ route('student.update', [$student->id]) }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input id="roll_no" name="roll_no" type="text"
                                        value="{{ $student->roll_no ? $student->roll_no : old('roll_no') }}"
                                        class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input id="name" name="name" type="text"
                                        value="{{ $student->name ? $student->name : old('name') }}" class="form-control">
                                    @if ($errors->has('name'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input id="dob" name="dob" type="date"
                                        value="{{ $student->dob ? $student->dob : old('dob') }}" class="form-control">
                                    @if ($errors->has('dob'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input id="address" name="address" type="text"
                                        value="{{ $student->address ? $student->address : old('address') }}"
                                        class="form-control">
