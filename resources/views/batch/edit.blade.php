                    ...
                    <div class="col-md-6">
                        ...
                        <form action="{{ route('batch.update', [$batch->id]) }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input id="name" name="name" type="text"
                                        value="{{ $batch->name ? $batch->name : old('name') }}" class="form-control">
                                    @if ($errors->has('name'))
                                    ...
                                    <select id="subject_id" name="subject_id" class="custom-select">
                                        ...
                                        @foreach ($subjects as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $batch->subject_id == $item->id ? 'selected' : '' }}>
                                                {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-10">
                                    <select id="teacher_id" name="teacher_id" class="custom-select">
                                        ...
                                        @foreach ($teachers as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $batch->teacher_id == $item->id ? 'selected' : '' }}>
                                                {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input id="batch_date" name="batch_date" type="date"
                                        value="{{ $batch->batch_date ? $batch->batch_date : old('batch_date') }}"
                                        class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input id="time" name="time" type="time"
                                        value="{{ $batch->time ? $batch->time : old('time') }}" class="form-control">
                                    @if ($errors->has('time'))
